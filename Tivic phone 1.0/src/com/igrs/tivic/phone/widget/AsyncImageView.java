...
import com.igrs.tivic.phone.widget.ImageRequest.ImageRequestCallback;
import com.igrs.tivic.phone.Utils.Config;
...
public class AsyncImageView extends ImageView implements ImageRequestCallback {
    ...
    public void getImageNow(String url) {
    	 mUrl = url;
    	 mRequest = new ImageRequest(mUrl, this, mImageProcessor, mOptions);
         mRequest.load(getContext());
    ...
    public void setAvaterUrl(String _url) {
     ...
     * @param size
     */
    public void setUrl(String url,int size){
